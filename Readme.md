...
# Parsing + Configuration Script – Dragino AQS01-L - Rev. A

This **Parsing + Configuration** script is designed for the **Dragino AQS01-L** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Dragino AQS01-L Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Dragino AQS01-L** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
